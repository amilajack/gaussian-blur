...
const array_range_1 = __importDefault(require("array-range"));
...
function coefficients(weights) {
    ...
    const offsets = array_range_1.default(mid + 1);
...
exports.default = coefficients;
exports.weights = "28    56    70    56    28" // 5 taps
